...
declare namespace wx {
  export function getMenuButtonBoundingClientRect():WXUIRect;
  /**
   * 批量添加卡券。
   */
   ...
   * 显示当前页面的转发按钮
   */
  export function showShareMenu(object: { withShareTicket?: boolean, success?: (res?: any) => void, fail?: (res?: any) => void, complete?: (res?: any) => void }): void;
...
interface BannerAd {
  ...
  /** 监听 banner 广告错误事件*/
  onError(callback: (res: { errMsg: string, errCode: 1000 | 1001 | 1002 | 1003 | 1004 | 1005 | 1006 | 1007 | 1008 | -12001}) => void): void;
  /** 取消监听 banner 广告错误事件*/
